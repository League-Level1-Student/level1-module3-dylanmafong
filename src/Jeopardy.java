...
public class Jeopardy implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(buttonPressed.equals(firstButton)) {
			askQuestion("In Basketball, how many points do you get if you throw the ball in the hoop?","2 points",200);
		}
		...
		// Or if the buttonPressed was the secondButton
				if(buttonPressed.equals(secondButton)) {
					askQuestion("In soccer, what happens when someone fouls someone in the Penalty box","a penalty kick", 400);
				}
				if(buttonPressed.equals(thirdButton)) {
					askQuestion("if you hit a homerun in baseball, and there are 3 people on base, how many runs do you get, and what is that called"," 4 runs and a grand slam",600);
				}
				if(buttonPressed.equals(fourthButton)) {
					askQuestion("if you swing on the third strike and miss in baseball, and the catcher misses the ball, what should you do?","run to first base",800);
				}
	...
	String c = JOptionPane.showInputDialog(question);
